...
@section('container')
    <div class="relative bg-gray-900 text-white h-[80vh]"> <!-- Adjust height here -->
        ...
        <div class="absolute inset-0">
            <img src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/212b34104893379.5f6cc87656bf0.gif" alt="Background GIF" class="w-full h-full object-cover">
        </div>
        ...
        <div class="relative container mx-auto py-16 px-4 sm:px-6 lg:px-8 text-center flex flex-col justify-center h-full">
            <h1 class="text-5xl font-extrabold sm:text-6xl lg:text-7xl mb-4">
            ...
            <div class="flex justify-center">
                <a href="/blog" class="inline-block px-6 py-3 text-lg font-semibold text-white border border-white rounded-lg bg-transparent hover:bg-gray-900 hover:border-gray-900 hover:text-white transition duration-300">Explore Blog Posts &raquo;</a>
            </div>
        </div>
    </div>
